  ...
  return (
    <div className="bg-white text-black w-full min-h-screen">
      <Head>
        ...
        <meta
          name="description"
          content="Limited edition fine art photography prints"
        />
      </Head>
      ...
      <main
        id="shop"
        className="max-w-[1440px] mx-auto px-4 pt-8 pb-20 scroll-mt-24">
...
export async function getStaticProps() {
  ...
  try {
    ...
    const products = json.data.collectionByHandle.products.edges.map(
      ({ node }) => {
